...
DATABASES = {
    'default': {
        ...
        'NAME': 'rich',                      # Or path to database file if using sqlite3.
...
STATICFILES_DIRS = (
    ...
    #('ueditor',os.path.join(MEDIA_ROOT,'ueditor_up').replace('\\','/') ), 
    #('ckeditor',os.path.join(MEDIA_ROOT, 'ckeditor_up').replace('\\','/') ), 
...
SECRET_KEY = '$(lqdakr75*9xvp5g2=gn8wk3ee76+%#%*4tasdq8@pm2d)ab-'
